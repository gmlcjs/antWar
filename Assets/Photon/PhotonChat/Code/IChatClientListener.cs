...
// 포톤 채팅 API는 클라이언트가 채팅 서버에 연결하고 다른 클라이언트와 통신할 수 있도록합니다.
namespace Photon.Chat
{
    ...
    // 채팅 클라이언트 측의 콜백 인터페이스. 업데이트에 대해 앱에 알리는 콜백 메서드를 포함합니다.
    public interface IChatClientListener
    {
        ...
        /// 라이브러리의 모든 디버그 출력은이 방법을 통해보고됩니다. 화면에 표시하거나 화면에 사용할 버퍼에 넣으십시오. (출력, 로그)
        void DebugReturn(DebugLevel level, string message);

        /// <summary>
        /// Disconnection happened.
        /// </summary>
        void OnDisconnected(); // 연결이 끊어졌을 때
        ...
        /// </remarks>
        void OnConnected(); // 클라이언트가 연결되었을 때
